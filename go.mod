...
require (
	...
	github.com/anchore/fangs v4.0.1
	github.com/anchore/go-collections v4.0.1
	github.com/anchore/go-logger v4.0.1
	github.com/anchore/go-macholibre v4.0.1
	...
	github.com/go-git/go-billy/v5 v5.12.0
...
require (
	...
	github.com/logrusorgru/aurora v4.0.0 // indirect
	...
	go.opentelemetry.io/contrib/instrumentation/net/http/otelhttp v1.59.2 // indirect
